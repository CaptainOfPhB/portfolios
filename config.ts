const config = {
  ...
  socialLinks: [
    { title: 'GitHub', icon: '/github.svg', url: 'https://github.com/CaptainOfPhB', width: 32, height: 32 },
    { title: 'blog', icon: '/blog.svg', url: 'https://daijiangtao.blog', width: 23, height: 23 },
    { title: 'Twitter', icon: '/twitter.svg', url: 'https://twitter.com/CaptainOfPhB' },
    { title: '知乎', icon: '/zhihu.svg', url: 'https://www.zhihu.com/people/CaptainInPHW' },
    { title: 'WeChat', icon: '/wechat.svg', url: 'https://picx.zhimg.com/80/v2-502fce7fabff98705dfab84cc58bb31d_1440w.png' },
  ],
  introductions: [
